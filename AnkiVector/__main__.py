...
PM_START_TEXT = """
𝙃𝙚𝙡𝙡𝙤 𝙩𝙝𝙚𝙧𝙚, 𝙄'𝙢 [Whitesnake]
𝙄'𝙢 𝙖 𝙋𝙤𝙬𝙚𝙧𝙛𝙪𝙡 𝙜𝙧𝙤𝙪𝙥 𝙢𝙖𝙣𝙖𝙜𝙚𝙧 𝙗𝙤𝙩 𝙒𝙞𝙩𝙝 𝘾𝙤𝙤𝙡 𝙈𝙤𝙙𝙪𝙡𝙚𝙨. 𝙈𝙖𝙙𝙚 𝙗𝙮 [@Dilasnalithmantha]
...
buttons = [
    [
        ...
        InlineKeyboardButton(text="🖲 ꜱᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ", url="https://t.me/whitesnake6bo"),
    ],
    [
        InlineKeyboardButton(text="📜 ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ", url="https://www.youtube.com/watch?v=fXXEcAkWAFU"),
        InlineKeyboardButton(text="❔ ʜᴇʟᴘ", url="http://t.me/Whitesnake6Bot?start=help"),
    ],
    [
        InlineKeyboardButton(
            text="➕ Whitesnake ᴀᴅᴅ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕", url="http://t.me/Whitesnake6Bot?startgroup=true"
        ),
    ],
]


ANKIVECTOR_IMG = "https://telegra.ph/file/dfe57f43d2a81c097807a.jpg"

HELP_STRINGS = f"""
*Main Commands :* [🤖](https://telegra.ph/file/dfe57f43d2a81c097807a.jpg)
